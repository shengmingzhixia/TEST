                ...
                <form action="updateEmployee" method="post">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="e_address" class="update1 form-control" disabled
                                   value="${requestScope.employee1.e_address}" required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <c:if test="${requestScope.employee1.e_state==2}">
                                <select name="e_state" class="form-control" disabled required>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="e_password" class="update1 form-control" disabled
                                   value="${requestScope.employee1.e_password}" required>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
