            ...
            <c:forEach items="${requestScope.recruitPage.list}" var="rct">
                <tr>
                    ...
                    <c:if test="${rct.rct_is_draft == 1}">
                        <td>未发布</td>
                        <td><a href="">修改</a></td>
                        <td><a href="updateRct?&rct_is_draft=0&rct_is_publish=1&rct_id=${rct.rct_id}">发布</a></td>
                    ...
                    <c:if test="${rct.rct_is_draft == 0}">
                        ...
                        <td colspan="3"><a href="updateRct?&rct_is_draft=1&rct_is_publish=0&rct_id=${rct.rct_id}">下架</a></td>
                        <%--下架时，更新时间为null--%>
                    </c:if>
                </tr>
            </c:forEach>
